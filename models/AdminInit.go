...
func insertPower() {
	...
	power := [16]Power{
		{Controller:"admin",Action:"index",Powername:"后台管理员管理",Pid:0}, //id 1
		{Controller:"admin/user",Action:"user",Powername:"用户列表",Pid:1},  //id 2
		{Controller:"admin/role",Action:"role",Powername:"角色列表",Pid:1},  //id 3
		{Controller:"admin/power",Action:"power",Powername:"权限列表",Pid:1}, //id 4
		{Controller:"admin/user",Action:"edit",Powername:"用户列表",Pid:2},
		{Controller:"admin/user",Action:"add",Powername:"用户列表",Pid:2},
		{Controller:"admin/user",Action:"upd",Powername:"用户列表",Pid:2},
		{Controller:"admin/user",Action:"del",Powername:"用户列表",Pid:2},
		{Controller:"admin/role",Action:"edit",Powername:"角色列表",Pid:3},
		{Controller:"admin/role",Action:"add",Powername:"角色列表",Pid:3},
		{Controller:"admin/role",Action:"upd",Powername:"角色列表",Pid:3},
		{Controller:"admin/role",Action:"del",Powername:"角色列表",Pid:3},
		{Controller:"admin/power",Action:"edit",Powername:"权限列表",Pid:4},
		{Controller:"admin/power",Action:"add",Powername:"权限列表",Pid:4},
		{Controller:"admin/power",Action:"upd",Powername:"权限列表",Pid:4},
		{Controller:"admin/power",Action:"del",Powername:"权限列表",Pid:4},
